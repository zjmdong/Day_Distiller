...
This document accompanies the historical firmware branch. This USB implementation offers discovery, status and a switch to mass-storage access. It pairs with the [earlier Windows client](https://github.com/zjmdong/Day_Distiller/tree/old/windows-dev-client-py).
